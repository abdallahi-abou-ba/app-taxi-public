...
const { topUpIdParamSchema, listTopUpsQuerySchema, adminCreateTopUpSchema } = require('../validators/wallet.validators');
...
router.post('/', validate(adminCreateTopUpSchema, 'body'), controller.createTopUpAsAdmin);
