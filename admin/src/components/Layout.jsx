...
const NAV_ITEMS = [
  ...
  { to: '/revenue', label: 'Recettes', permission: ['REVENUE'] },
  { to: '/expenses', label: 'Dépenses', permission: ['EXPENSES'] },
  { to: '/settlements', label: 'Règlements', permission: ['SETTLEMENTS'] },
  { to: '/reports', label: 'Rapports', permission: ['REPORTS'] },
