...
export default function WalletTopUpListPage() {
  ...
  return (
    <div>
      ...
      <p className="hint">
        Les recharges par carte sont confirmées automatiquement une fois le paiement Stripe abouti. Les recharges par
        mobile money doivent être confirmées ici une fois le virement vérifié.
      </p>
